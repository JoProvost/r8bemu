...
public class SAMVideoMemory implements VideoMemory {
    private final DataOutput mode;
    private MemoryDevice ram;
    private DataAccess offset;

    public SAMVideoMemory(MemoryDevice ram, DataOutput mode, DataAccess offset) {
        this.mode = mode;
        this.offset = offset;
        this.ram = ram;
    }
    ...
    public void previous() {
        offset.update(Subtraction.decrement());
    }

    @Override
    public void next() {
        offset.update(Addition.increment());
    }
}
