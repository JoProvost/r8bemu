...
class DisjunctionTest {
    @Test
    void negative() {
        var result = Constant.asByte(0b00010010).or(Constant.asByte(0b10100110));
        assertEquals(0b10110110, result.unsigned());
        assertFalse(result.overflow());
        assertTrue(result.negative());
        assertFalse(result.zero());

        var result2 = Constant.asByte(0b10010010).or(Constant.asByte(0b00100110));
    ...
    @Test
    void positive() {
        var result = Constant.asByte(0b00010010).or(Constant.asByte(0b00100110));
    ...
    @Test
    void zero() {
        var result = Constant.asByte(0).or(Constant.asByte(0));
