...
class SC77526Test {
    ...
    void sendAudioAsSignedByteWhenEnabled() {
        ...
        sc77526.dac().handle(BinaryValue.of(16, 0x3f));
        ...
        sc77526.dac().handle(BinaryValue.of(63, 0x3f));
    ...
    void leftJoystickHorizontalComparedAgainstDAC() {
        BinaryRegister hiLo = BinaryRegister.ofMask(0x01);
        sc77526.selA().handle(value(false));
        sc77526.selB().handle(value(false));
        sc77526.joy(0).value((20-32) / 32.0);

        sc77526.dac().handle(BinaryValue.of(20, 0x3f));
        sc77526.cmp().provide(hiLo);
        assertEquals(0x01, hiLo.value());

        sc77526.dac().handle(BinaryValue.of(21, 0x3f));
        sc77526.cmp().provide(hiLo);
    ...
    void leftJoystickVerticalComparedAgainstDAC() {
        ...
        sc77526.dac().handle(BinaryValue.of(30, 0x3f));
        sc77526.cmp().provide(hiLo);
        assertEquals(0x01, hiLo.value());

        sc77526.dac().handle(BinaryValue.of(31, 0x3f));
        sc77526.cmp().provide(hiLo);
        assertEquals(0x00, hiLo.value());
    }
