...
class MMUTest {
    ...
    MemoryDevice ram = new Memory(0x7ffff) {{
    ...
    MemoryDevice rom = new Memory(0x7fff) {{
    ...
    MemoryDevice cart = new Memory(0x1fff) {{
        write(0xc000, "DISK BASIC".getBytes());
    }};

    MemoryDevice pia0 = new Memory(0x1f) {{
        write(0xff00, "PIA0".getBytes());
    }};
    MemoryDevice pia1 = new Memory(0x1f) {{
        write(0xff20, "PIA1".getBytes());
    }};
    MemoryDevice disk = new Memory(0x3f) {{
