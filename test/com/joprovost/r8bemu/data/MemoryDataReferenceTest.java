...
class MemoryDataReferenceTest {
    MemoryDevice memory = new StringMemory();

    @Test
    void readSingleByte() {
        var data = MemoryDataReference.of(memory, 10, Size.WORD_8);
        memory.write(10, 55);
    ...
    void writeSingleByte() {
        var data = MemoryDataReference.of(memory, 5, Size.WORD_8);
        data.value(88);
    ...
    @Test
    void read16bitWord() {
        var data = MemoryDataReference.of(memory, 10, Size.WORD_16);
    ...
    @Test
    void write16bitWord() {
        var data = MemoryDataReference.of(memory, 5, Size.WORD_16);
        data.value(0x1234);
