...
class MC6809ETest {
    ...
    private final Debugger debugger = Debugger.none();
    ...
    void nopTakesTwoTicks() throws IOException {
        ...
        MC6809E cpu = new MC6809E(new Memory(new byte[]{(byte) 0x12, (byte) 0x12}), debugger, clock);
        PC.set(0x0000);
    ...
    void abx() throws IOException {
        MemoryMapped memory = new Memory(0xffff);
        MC6809E cpu = new MC6809E(memory, debugger, new FakeBusyState());
        B.set(0x15);
        X.set(0x1202);
        PC.set(0x0000);
